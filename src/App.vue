    ...
    <header>
      <b-navbar type="dark" variant="info">
        <b-navbar-nav>
          ...
          <b-nav-item v-if="$app.notLoggedIn" to="/register"> Register </b-nav-item>
          <b-nav-item v-if="$app.loggedIn && $store.state.user.admin" to="/admin">
            Admin
          </b-nav-item>

          <!-- Navbar dropdowns -->
          <b-nav-item-dropdown v-if="$app.loggedIn && $store.state.user.admin" text="Admin" right>
            ...
            <b-dropdown-item to="/admin/advertisement">advertisement </b-dropdown-item>
          </b-nav-item-dropdown>
        ...
        <b-navbar-nav class="ml-auto">
          <b-nav-item-dropdown v-if="$app.loggedIn" text="User" right>
            ...
            <b-dropdown-item to="/" @click="$app.logout()">Logout </b-dropdown-item>
          </b-nav-item-dropdown>
        </b-navbar-nav>
      </b-navbar>
    </header>
